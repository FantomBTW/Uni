...
1) продемонстрировать ручной ввод, в рамках которого осуществляется поэлементный ввод неупорядоченного массива из M строк и N столбцов, состоящий из элементов длиной не более 8-ми символов;
2) вывод массива в «табличном виде» с полями одинаковой ширины.
...
Я научился управлять курсором и работать с массивами в masm32
